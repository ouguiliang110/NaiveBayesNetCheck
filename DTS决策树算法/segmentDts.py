...
for i in range(0, 20):
    ...
    trainingSet = np.vstack((Data1, Data2, Data3, Data4,Data5,Data6,Data7))
    ...
    acc.append((add + add1 + add2 + add3+add4+add5 + add6 ) / (test1 + test2 + test3 + test4+test5 + test6 + test7 ))
    print("accuracy:{:.2%}".format((add + add1 + add2 + add3+add4+add5 + add6) / (test1 + test2 + test3 + test4+test5 + test6 + test7)))
