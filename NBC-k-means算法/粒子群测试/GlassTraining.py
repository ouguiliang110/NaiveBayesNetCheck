...
W = getRandom(m * 6) * 10
W=[0.06488417470893981,2.088343768081512,2.4728166691287816,1.4013054890692842,2.9072805771317167,3.090570248874576,3.152667415230464,0.13906970995319823,3.3707529646167633,0.7868391846458008,0.7062168966515395,2.14877953495419,2.6864933925239223,2.241567271862866,3.937508422400726,1.4436047214280319,0.02181907271595283,1.3841438412033416,1.3992221029378393,0.07188642977821921,0.38728583295839863,0.45525482941862033,1.457992867305682,4.392639288501621,0.6962050735793948,0.5315672083984637,2.4677419640886122,0.4130928101553324,0.39828144072754396,9.279874108869258,0.8507158079815385,0.15445692898610097,0.7162834410967718,0.23622166850456083,1.7176500442403728,0.010819412862877542,0.7323720431531033,0.42600330437984363,4.452598354040327,2.0021021752005725,2.0551209214710897,3.121137907504234,3.3382683132833955,0.38920842081060847,4.016813706933385,4.323930805436317,1.504522067579264,1.268480251129838,1.4966607684705564,0.6080472965451246,0.1850951522414957,0.4369882627551892,3.6111904282129474,6.349605205279866]
print(W)
# 求类1的分组情况
...
#训练集
trainSet1 = X[0:35, :]  # 35
trainSet2 = X[70:108, :]  # 38
trainSet3 = X[146:154, :]  # 8
trainSet4 = X[163:177, :]  # 14
trainSet5 = X[192:198, :]  # 6
trainSet6 = X[205:209, :]  # 4
# trainingSet = np.vstack((Data1, Data2))
#验证集
valSet1=X[35:49,:]   #14
valSet2=X[108:123,:]   #15
valSet3=X[154:157,:]   #3
valSet4=X[177:184,:]   #6
valSet5=X[198:201,:]   #3
valSet6=X[209:211,:]   #2
...
testSet3 = X[157:163, :]  # 5
testSet4 = X[184:192, :]  # 9
