...
# 随机产生多少个和为1的随机数W
G1=[15, 16, 17, 18, 19, 20, 21, 22, 24, 25, 29, 33, 34, 35, 36]
G2=[44, 53]
G3=[37]
G4=[23, 26, 28, 31]
G5=[5, 6, 11, 13, 14, 27, 30, 32, 38, 39, 40, 56]
G6=[41, 45]
G7=[0, 1, 2, 3, 4, 7, 8, 9, 10, 12, 42, 43, 46, 47, 48, 49, 50, 51, 52, 54, 55, 57, 58, 59]
#求类1的分组情况
NewArray = np.ones((97, 8))
# 第0组
W1 = getRandom(15)
for i in range(0, 97):
    add1 = 0
...
# 去掉类标记
NewArray = np.delete(NewArray, 7, axis = 1)
