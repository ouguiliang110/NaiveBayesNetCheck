...
def CountIndependenceMatrix(my_matrix):
    ...
    Add_All.append(my_matrix[min_index,min_index_1])
    ...
    plt.plot(np.arange(len(Add_All)), Add_All, color = 'blue')
    plt.show()
...
def CountRelevantMatrix(my_matrix):
    ...
    Add_All.append(my_matrix[max_index,max_index_1])
...
if __name__ == '__main__':
 ...
 for o in range(1):
    X = np.loadtxt('../数据集/[023]sonar(0-1).txt')
    print(X.shape[1]-1)
    '''
