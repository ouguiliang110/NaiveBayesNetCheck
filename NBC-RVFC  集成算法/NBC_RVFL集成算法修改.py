...
def CountIndependenceMatrix(my_matrix):
    ...
    #plt.plot(np.arange(len(Add_cha)), Add_cha, color = 'green', label = 'NBC_RVFL')
    #plt.plot(np.arange(len(Add)),)
    #plt.show()
...
if __name__ == '__main__':
    ...
    for k in range(0, 1):
        ...
        print ('DO-RVFL-NBC 训练时间',end-start)
        ...
        print('DO-RVFL-NBC 测试时间', end - start)
        #print(acc3)
